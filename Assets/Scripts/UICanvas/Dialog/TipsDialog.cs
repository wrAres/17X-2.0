...
public class TipsDialog : MonoBehaviour
{
    ...
    void Awake() {
        ...
        dialogList.Add("EastClouds");
        dialogList.Add("WestClouds");
        dialogList.Add("coral1");
        dialogList.Add("coral1 (1)");
        dialogList.Add("coral1 (2)");
        dialogList.Add("coral1 (3)");
        dialogList.Add("coral1 (4)");
        dialogList.Add("coral1 (5)");
        dialogList.Add("coral1 (6)");
        dialogList.Add("coral1 (7)");
        dialogList.Add("coral1 (8)");
        dialogList.Add("coral1 (9)");
        dialogList.Add("coral1 (10)");
        dialogList.Add("coral1 (11)");
        dialogList.Add("coral1 (12)");
        dialogList.Add("coral1 (13)");
        dialogList.Add("coral1 (14)");
        dialogList.Add("coral1 (15)");
        dialogList.Add("coral1 (16)");
        dialogList.Add("coral1 (17)");
        dialogList.Add("Separate Mirror");
        dialogList.Add("stargc");
        dialogList.Add("Left Reefs");
        dialogList.Add("Right Reefs");
