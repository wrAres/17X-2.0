...
public class WaterSoundManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        playerStepSound = Resources.Load<AudioClip>("Sound/Steps/step_water");
        player1StepSound = Resources.Load<AudioClip>("Sound/Steps/step_water_1");
